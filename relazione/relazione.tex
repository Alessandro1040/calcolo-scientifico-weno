...
il codice allegato descrive un approccio falimentare di lax wendroff giusto? usando taylor direttamente, sai dirmi se quell'approccio è presente tra i metodi numerici disponibili nel file html che ti ho mandato? inoltre nel codice c'è anche la correzione di lax wendroff, puoi dirmi se c'è quello corretto sempre nell'html?
